 ...
 * @since 4.0
 */
public class SenecaParameterizedTestRunner extends Suite {
    /**
    ...
    private class TestClassRunnerForParameters extends SenecaTestRunner {
     ...
     */
    public SenecaParameterizedTestRunner(Class<?> klass) throws Throwable {
    ...
    private String nameFor(String namePattern, int index, Object[] parameters) {
        ...
        int iteration=Integer.parseInt(name);
        name="Row "+(iteration+1);
