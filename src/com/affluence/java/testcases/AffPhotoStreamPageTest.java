...
import com.affluence.java.pages.PhotoStreamPage;
...
public class AffPhotoStreamPageTest extends Page {
	 ...
	 */
	@Test  
	  public void affPhotoStreamPageTest() throws Exception {
            ...
            homePage.gotoPhotoStreamPage();
            PhotoStreamPage photoStreamPage=PageFactory.initElements(driver,PhotoStreamPage.class);
            photoStreamPage.verifyPhotoStreamPage();
