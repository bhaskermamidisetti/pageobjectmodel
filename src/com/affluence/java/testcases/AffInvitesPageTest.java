...
import com.affluence.java.pages.InvitesPage;
...
public class AffInvitesPageTest extends Page {
	    ...
	    public static Collection spreadsheetData() throws IOException {
	        ...
	        return new SpreadsheetData(spreadsheet,AffInvitesPageTest.class.getSimpleName()).getData();
	    }
	     ...
	     * @param b
	     */
	    public AffInvitesPageTest(String a, String b,String c) {
	        super();
	        this.User_Name = a;
	 ...
	 */
	 @Test  
	  public void affInvitesPageTest() throws Exception {
            ...
            homePage.gotoInvitesPage(testName);
            InvitesPage invitesPage=PageFactory.initElements(driver,InvitesPage.class);
            invitesPage.verifyInvitesPage();
