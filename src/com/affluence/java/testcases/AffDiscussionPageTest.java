...
import com.affluence.java.pages.DiscussionPage;
...
public class AffDiscussionPageTest extends Page {
	    ...
	    public static Collection spreadsheetData() throws IOException {
	        ...
	        return new SpreadsheetData(spreadsheet,AffDiscussionPageTest.class.getSimpleName()).getData();
	    }
	     ...
	     * @param b
	     */
	    public AffDiscussionPageTest(String a, String b,String c) {
	        super();
	        this.User_Name = a;
	 ...
	 */
	  @Test
	  public void affDiscussionPageTest() throws Exception {
            ...
            homePage.gotoDiscussiongePage();
	  		DiscussionPage discussionPage=PageFactory.initElements(driver,DiscussionPage.class);
	  		discussionPage.verifyDiscussionPage();
